...
class Catamaran < Boat
  ...
  def initialize(num_propellers, num_hulls, km_per_liter, liters_of_fuel_capacity)
    super
  end
end

class Motorboat < Boat
  def initialize(km_per_liter, liters_of_fuel_capacity)
    super(1, 1, km_per_liter, liters_of_fuel_capacity)
  end
end
